...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <img
        src={heroBg}
        alt="AGRILINK premium background"
      ...
      <div className="relative z-10 container mx-auto px-6 pt-24 pb-16 text-center">
        ...
        <p className="animate-fade-up-delay-2 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
          Acquire premium industrial products and earn <span className="text-gold font-semibold">2× returns</span> over a 50-day generation period. Guaranteed daily income, powered by AGRILINK.
        </p>
