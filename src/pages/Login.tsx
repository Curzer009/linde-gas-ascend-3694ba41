    ...
    <div className="min-h-screen bg-transparent flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <img src="/agrilink-mark.jpg" alt="AGRILINK logo" className="w-16 h-16 rounded-full object-cover border border-gold/30 mx-auto mb-4" />
        ...
        <form onSubmit={handleLogin} className="bg-card rounded-3xl border border-gold/10 p-8 space-y-5">
          <div>
            <label htmlFor="login-username" className="block text-sm font-medium text-muted-foreground mb-2">Username or Phone Number</label>
            <input
              id="login-username"
              type="text"
              value={username}
